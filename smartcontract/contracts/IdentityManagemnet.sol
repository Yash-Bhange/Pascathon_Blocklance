...
contract IdentityManagement
{
    ...
    */
    ...
    function ViewDLRequestHeader(address UserAddress, uint RequestIndex) public returns(string memory RequestedBy, uint DL_OverAll_Status)
    {
    ...
    function ViewDLRequestDetail(address UserAddress, uint RequestIndex) public returns(string memory RequestedBy, uint DL_No, uint DL_Name, uint DL_DOB, uint DL_Hash, uint DL_Address, uint DL_OverAll_Status)
    {
        DLRequest memory ThisDLRequest=DLRequestMap[UserAddress][RequestIndex];
    ...
    function viewUser(address UserAddress, uint UserIndex) public returns(string memory FullName,string memory EmailID,uint MobileNo)
    {
     ...
     function viewUserDL(address UserAddress, uint RequestIndex) public returns(uint DL_No_S, string memory DL_No_V, uint DL_Name_S, string memory DL_Name_V, uint DL_DOB_S, string memory DL_DOB_V, uint DL_Hash_S, string memory DL_Hash_V, uint DL_Address_S, string memory DL_Address_V)
    {
